...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_700: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_2221: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_10233: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2223: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_703: (a: number, b: number) => void;
